...
urlpatterns = [
    ...
    path(
        "backups/purge_confirm/",
        views.BackupPurgeAllConfirm.as_view(),
        name="backup-purge-confirm",
    ),
    ...
    path(
        ...
        views.BackupDownload.as_view(),
        name="backup-download",
    ),
    path(
        "backups/<int:pk>/delete/", views.BackupDelete.as_view(), name="backup-delete"
    ),
    path(
        "backups/<int:pk>/restore/",
        views.BackupRestore.as_view(),
        name="backup-restore",
    ),
    # Uploads
    ...
    path(
        "uploads/<int:pk>/delete/", views.UploadDelete.as_view(), name="upload-delete"
    ),
    # Classes
    path("classes/<int:pk>/", views.ClassView.as_view(), name="class-detail"),
    path(
        "classes/<int:pk>/update/", views.BudgetUpdate.as_view(), name="budget-update"
    ),
    # Categories
    ...
    path(
        "patterns/<int:pk>/update/",
        views.PatternUpdate.as_view(),
        name="pattern-update",
    ),
    path(
        "patterns/<int:pk>/delete/",
        views.PatternDelete.as_view(),
        name="pattern-delete",
    ),
    ...
    path(
        "patterns/upload/",
        views.PatternBulkUpdate.as_view(),
        name="pattern-bulk-update",
    ),
    # Transactions
